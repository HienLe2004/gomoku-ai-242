...
class Game:
    def __init__(self):
        ...
        self.black_options = pygame_gui.elements.UIDropDownMenu(options_list=['Human','AI'], 
        ...
        self.white_options = pygame_gui.elements.UIDropDownMenu(options_list=['Human','AI'], 
                                                                starting_option='Human',
    ...
    def draw(self):
        ...
        text_2 = font.render("White", True, (0,0,0))
        ...
        if self.grid.state == Game_State.DRAW:
            ...
            result = "Black win!"
        if result != None:
            text_3 = font.render(result, True, (0,0,0))
